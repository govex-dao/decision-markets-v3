...
fun test_add_to_balance() {
    ...
    conditional_balance::add_to_balance_pkg(&mut balance, 0, true, 100);
    assert!(conditional_balance::get_balance(&balance, 0, true) == 100, 0);

    conditional_balance::add_to_balance_pkg(&mut balance, 0, true, 50);
    assert!(conditional_balance::get_balance(&balance, 0, true) == 150, 1);

    conditional_balance::add_to_balance_pkg(&mut balance, 0, true, 850);
...
fun test_sub_from_balance() {
    ...
    conditional_balance::sub_from_balance_pkg(&mut balance, 0, false, 300);
    assert!(conditional_balance::get_balance(&balance, 0, false) == 700, 0);

    conditional_balance::sub_from_balance_pkg(&mut balance, 0, false, 200);
    assert!(conditional_balance::get_balance(&balance, 0, false) == 500, 1);

    conditional_balance::sub_from_balance_pkg(&mut balance, 0, false, 500);
...
fun test_sub_from_balance_insufficient_fails() {
    ...
    conditional_balance::sub_from_balance_pkg(&mut balance, 0, true, 101);
...
fun test_add_zero_amount() {
    ...
    conditional_balance::add_to_balance_pkg(&mut balance, 0, true, 0);
    assert!(conditional_balance::get_balance(&balance, 0, true) == 100, 0);
...
fun test_sub_zero_amount() {
    ...
    conditional_balance::sub_from_balance_pkg(&mut balance, 0, false, 0);
...
fun test_add_causes_overflow() {
    ...
    conditional_balance::add_to_balance_pkg(&mut balance, 0, true, 1);
...
fun test_full_lifecycle() {
    ...
    let mut i = 0u8;
    while (i < 3) {
        conditional_balance::add_to_balance_pkg(&mut balance, i, true, deposit_amount);
        conditional_balance::add_to_balance_pkg(&mut balance, i, false, deposit_amount);
        i = i + 1;
    };
    ...
    conditional_balance::sub_from_balance_pkg(&mut balance, 1, true, 300);
    conditional_balance::sub_from_balance_pkg(&mut balance, 1, false, 400);
    ...
    i = 0;
    while (i < 3) {
        conditional_balance::sub_from_balance_pkg(&mut balance, i, true, min_asset);
        conditional_balance::sub_from_balance_pkg(&mut balance, i, false, min_stable);
        i = i + 1;
    };
